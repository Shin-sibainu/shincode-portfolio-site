...
const Contact = () => {
  return (
    <div className="bg-primary-900 w-full h-[280px] py-16 px-6.67">
      <div className="w-full max-w-[1248px] px-6">
        <div className="gap-8 flex flex-col items-center">
          <div className="text-white font-notoSansJP text-2xl leading-9 font-bold tracking-wider text-center">
          ...
          <Link href="/#" className="flex items-center gap-5 bg-white py-3 w-[252px] h-12 rounded-sm border border-white transition duration-300 ease-out hover:bg-primary-100 shadow-custom">
            <p className="font-notoSansJP text-base font-bold text-left pl-10">お問い合わせはこちら</p>
            <Image
