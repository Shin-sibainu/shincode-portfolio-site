...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-500 data-[state=open]:duration-500",
  {
    variants: {
      side: {
        top: "inset-x-0 top-[78px] border-b data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
        bottom:
...
const SheetContent = React.forwardRef<
  ...
  SheetContentProps
>(({ side = "top", className, children, closeable = true, ...props }, ref) => (
  <SheetPortal>
    <div className="fixed inset-0 bg-transparent" style={{pointerEvents: 'all', top: '78px', zIndex: 30}} />
    <SheetOverlay />
